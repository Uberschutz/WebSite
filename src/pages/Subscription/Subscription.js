                ...
                <div>
                    <div className="row">
                        <div className="col-xl-4">
                            ...
                            <button type="button" className="btn btn-info" onClick={this.addLicence} data-idx={0}>Acheter</button> <br/>
                        </div>
                        <div className="col-xl-4">
                            ...
                            <button type="button" className="btn btn-info" onClick={this.addLicence} data-idx={1}>Acheter</button> <br/>
                        </div>
                        <div className="col-xl-4">
                            ...
                            Avantages ! <br/>
                            - Profitez de ... <br/> <br/>
                            <button type="button" className="btn btn-info" onClick={this.addLicence} data-idx={2}>Acheter</button> <br/> <br/> <br/> <br/>
                        </div>
                    </div>
                </div>
            </div>
